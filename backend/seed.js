...
const opportunitiesData = [
  ...
  { title: "Part-time Technical Writer", company: "Google India", description: "Author premium technical APIs documentation, tutorials, and getting started manuals.", requiredSkills: ["Technical Writing", "JavaScript", "Markdown", "Git"], location: "Remote (India)", type: "part-time", stipend: "45000", duration: "3 Months" },
  { title: "Freelance UI/UX Designer", company: "CRED", description: "Audit design prototypes and formulate dark-mode themed micro-interaction interfaces.", requiredSkills: ["Figma", "UI/UX Design", "Wireframing", "User Research"], location: "Remote", type: "freelance", stipend: "80000", duration: "1 Month" },
  { title: "Part-time Python Tutor", company: "Microsoft India", description: "Conduct mentorship lectures and facilitate code challenges sessions for junior interns.", requiredSkills: ["Python", "Teaching", "Data Structures", "Algorithms"], location: "Remote (India)", type: "part-time", stipend: "35000", duration: "6 Months" },
  { title: "Freelance Smart Contract Auditor", company: "Coinbase", description: "Conduct security threat profiling on Solidity agreements and token swap protocols.", requiredSkills: ["Solidity", "Smart Contracts", "Hardhat", "Cryptography"], location: "Remote", type: "freelance", stipend: "150000", duration: "2 Weeks" },
  { title: "Part-time Content Specialist", company: "Swiggy", description: "Draft culinary reviews, promotional copy material, and food logistics newsletters.", requiredSkills: ["Copywriting", "Creative Writing", "Content Strategy"], location: "Remote", type: "part-time", stipend: "25000", duration: "4 Months" },
  { title: "Freelance React Native Developer", company: "Zomato", description: "Optimize image delivery lazy-loads and screen navigation actions on the main app.", requiredSkills: ["React Native", "JavaScript", "Redux", "API Integration"], location: "Remote", type: "freelance", stipend: "95000", duration: "2 Months" }
];
